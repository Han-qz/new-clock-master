...
/**
 * The main activity of the application which displays 4 different tabs contains alarms, world clocks, timers and a stopwatch.
 * 显示4个不同选项的应用程序的主activity：包括闹钟、世界时钟、计时器、秒表
 */
public class DeskClock extends BaseActivity
    ...
    // Coordinates handling of context menu items. 协调处理上下文菜单项
    ...
    //hows/hides a snackbar explaining which setting is suppressing alarms from firing.
