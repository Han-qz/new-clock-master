 ...
 * 此服务仅用于允许秒表通知更改秒表的状态，而不干扰通知阴影。
 * 如果使用了活动（即使是未显示的活动），通知管理器会隐式关闭通知阴影，这与启动/暂停/重叠/重置秒表的用例冲突，而不会干扰通知阴影。
 */
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        switch (action) {
            case ACTION_SHOW_STOPWATCH: {
                ...
                // Open DeskClock positioned on the stopwatch tab. 打开秒表选项卡上的DeskClock。
